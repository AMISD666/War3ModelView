...
type blp_BLPContent = BLPContent;
declare const blp_BLPContent: typeof BLPContent;
type blp_BLPImage = BLPImage;
type blp_BLPMipMap = BLPMipMap;
type blp_BLPType = BLPType;
declare const blp_BLPType: typeof BLPType;
declare namespace blp {
  export { blp_BLPContent as BLPContent, blp_BLPType as BLPType };
  export type { blp_BLPImage as BLPImage, blp_BLPMipMap as BLPMipMap };
}
...
declare const war3model: {
    model: typeof model;
    parseMDX: typeof parse;
    generateMDX: typeof generate;
    parseMDL: typeof parse$1;
    generateMDL: typeof generate$1;
    blp: typeof blp;
    decodeBLP: typeof decode;
    getBLPImageData: typeof getImageData;
