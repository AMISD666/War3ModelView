...
await transpile('src/renderer/src/application/model-import/FbxAnimationTransforms.ts')
...
console.log('OK FBX animation sequence interval uses actual mapped key duration, not padded playback duration.')
